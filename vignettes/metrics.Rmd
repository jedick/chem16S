...
taxon_Zc <- canprot::calc.metrics(taxon_AA, "Zc")[, 1]
...
taxon_nH2O <- canprot::calc.metrics(taxon_AA, "nH2O")[, 1]
...
metrics <- canprot::calc.metrics(AAcomp, c("H_C", "O_C", "N_C", "S_C", "GRAVY", "pI", "MW", "Length"))
