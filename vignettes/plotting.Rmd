...
The visualization of diversity metrics for communities often takes the form of ordinations, which are a type of dimensionality reduction that associates trends in the data with one or more synthetic variables.
...
Then, we'll explore specific hypothesis about the effects of redox conditions and salinity on genomic adaptation by analyzing datasets for microbial communities in marine sediment [@FEN+22] and geothermal waters [@ZFZ+23].
