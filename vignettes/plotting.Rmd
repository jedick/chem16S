...
To test this new hypothesis, analyses of datasets where either redox potential or OM content are controlled (or do not vary) should be done in order to identify the effect of each variable alone.
